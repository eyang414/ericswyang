  ...
  <div className="container-contact">
    ...
    <div className="col-md-8 col-sm-8 col-xs-11">
      <div style={displayNone}>
        <a target="_blank" href="http://github.com/eyang414" className="">
          <span className="link-response">http://github.com/eyang414</span>
        </a>
      </div>
      <div className="contact-link">
        <a target="_blank" href="https://www.linkedin.com/in/ericswyang/" className="">
      ...
      <div className="contact-link">
        <a target="_blank" href="https://stackoverflow.com/users/story/7667185" className="">
      ...
      <div className="contact-link">
        <a target="_blank" href="https://angel.co/eric-yang-20" className="">
