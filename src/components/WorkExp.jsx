        ...
        <div className="col-md-8 col-sm-8">
          ...
          <div className="col-md-8 col-sm-8">
            ...
            <div className="degree-descr">
              At FSA, I created several apps dealing with both frontend and backend code.  Working on SuperFriend, I developed backend database models with PostgreSQL while utilizing functionalities within JavaScript and Node.js to extract iMessage chat history from local drives to deliver the data to our web servers through an iFrame connection. I also wrote tests using Mocha+Chai.js.
              <br></br>
